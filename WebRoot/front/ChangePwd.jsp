...
<body>
    ...
    <!-- 注册 -->
    <div class="register">
        <form id="bdyz" method="post" action="UpdatePassword_front">
            <div class="tel clearfix">
                <span>旧密码</span>
                <input onblur="checkold()" type="password" id="oldpwd">
                <i id="m"></i>
            </div>
            <div class="tel clearfix">
                <span>新密码</span>
                <input type="password" readonly="readonly" id="npwd">
            </div>
            <div class="tel clearfix">
                <span>确认密</span>
                <input onblur="checksamepwd()" type="password" readonly="readonly" id="cnpwd">
            </div>
            <div class="tel clearfix">
                <span></span>
                <input onclick="updatepwd()" id="sub" disabled="disabled" type="button" value="修改密码" class="sub">
            </div>
        </form>
    </div>
    <!-- footer -->
