...
<body>
    ...
    <!-- 宝贝信息 -->
    <form action="ReleaseIdle" method="post"  enctype="multipart/form-data">
    <div class="bbxx wrap">
    	...
    	<div class="biaodan"><span>宝贝价格：</span><input name="transfer_price" type="text" /></div>
    	<div class="biaodan"><span>宝贝成色：</span><input name="percentage" type="text" /></div>
    	<div class="biaodan"><span>宝贝位置：</span><input name="location" type="text" /></div>
