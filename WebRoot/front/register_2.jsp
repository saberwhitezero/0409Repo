...
<body>
	...
	<div class="header">
		<div class="header_main wrap">
			...
			<ul class="header_menu clearfix">
				...
				<li class="header_mycenter"><a href="#" class="active">个人中心</a>
	...
	<!-- 注册 -->
	<div class="register">
		<form id="bdyz" method="post" action="FinalReg">
			<div class="tel clearfix">
				<span>密码</span> <input type="password" id="txt1" name="pwd">
				<i id="txt2"></i>
			</div>
			<div class="tel clearfix">
				<span>确认密</span> <input onblur="checkpwd()" type="password"
					id="text2"><i id="m"></i>
			</div>
			<div class="tel clearfix">
				<span></span> <input type="submit" id="reg" value="注册" class="sub"
					disabled="disabled">
			</div>
		</form>
	</div>
	...
	<script>
		function checkpwd() {
			...
			var pwd2 = $('#text2').val();
			if(pwd1==pwd2){
				var msg = "<font color='green'>√</font>";
				$('#m').html(msg);
				$('#reg').removeAttr('disabled');
			} else {
				var msg = "<font color='red'>两次密码不一致</font>";
				$('#m').html(msg);
			}
		}
	</script>
