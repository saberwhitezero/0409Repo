	...
	<div class="register">
		<form id="bdyz">
			<div class="tel clearfix">
				<span>手机号</span> <input onblur="checkphone()" type="text" id="phone" />
				<i id="txt2"></i>
			</div>
			<div class="tel clearfix">
				<span>验证码</span> <input type="text" disabled="disabled" id="text2">
			</div>
			<div class="tel clearfix">
				<span></span> <input type="button" onclick="zhuce()" value="下一步" class="sub">
			</div>
		</form>
		<!--  <script>
