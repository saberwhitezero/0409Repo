...
<body>
	...
	<div class="formbody">
		...
		<ul class="forminfo" style="display: none;" id="forminfo">
			<li><label>关键词</label> <input id="keywords" name="" type="text"
				class="dfinput" /> <i>关键词不能超过10个字符</i></li>
			<li><label>&nbsp;</label> <input name="" type="button"
				class="btn" value="添加" onclick="savekeywords()" /></li>
		</ul>
	</div>
	<div class="rightinfo">
		<div class="tools">
			<ul class="toolbar">
				...
				<li onclick="deletekeywords()"><span><img
